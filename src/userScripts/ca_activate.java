...
public class ca_activate extends HttpServlet {
  ...
  protected void doGet(
    ...
    String url = "sunnydhama:mysql://localhost:3306/sunnydhama_db";
    ...
    try {
      ...
      if (result.next()) {
        ...
        String emailtemp =
          ...
          name +
          ",</span></p><p><span style=\"font-size:14px;\">Welcome to sunnydhama! Your username&#xA0;is<b>&#xA0;</b></span><span style=\"font-size:14px;\"><strong>" +
          msg +
          "</strong>.</span></p><p><span style=\"font-size:14px;\">Regards,<br>Cloud Admin - sunnydhama</span><br>(This is system generated mail and should not be replied to)</p></div></td></tr></tbody></table></div><!--[if mso | IE]>      </td></tr></table>      <![endif]--></td></tr></tbody></table></div><!--[if mso | IE]>      </td></tr></table>      <![endif]--></div></body></html>";
        ...
        int i = st.executeUpdate(
          "update reg set status = 'Yes', audd='" +
          key_uid +
          "' where email = '" +
          u_email +
          "'"
        ...
        if (i != 0) {
          ...
          if (type.equals("user")) {
            ...
            boolean skGen = kg.aaKeyGen(msg);
          } else if (type.equals("aa")) {
            ListGen lg = new ListGen();
            boolean aaLGen = lg.aaListGen(msg);
          }
