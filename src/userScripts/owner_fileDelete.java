  ...
  protected void doGet(
    ...
    try {
      ...
      ResultSet rs = st.executeQuery(
        "SELECT filename FROM file_upload WHERE id = " +
        id +
        " and owner = \"" +
        owner +
        "\""
      ...
      int n = aaArr.length;
      for (int i = 0; i < n; i++) st.executeUpdate(
        "DELETE FROM " + aaArr[i] + " WHERE fname = \"" + fname + "\""
      );
      ...
      Logger
        .getLogger(owner_fileDelete.class.getName())
